...
int ducknng_register_sql_registry(duckdb_connection con, ducknng_sql_context *ctx) {
    ...
    if (!DUCKNNG_REGISTER_VOLATILE_SCALAR(con, "ducknng_register_sql_method", 3, ducknng_register_sql_method_scalar, ctx, register_sql_method_types, DUCKDB_TYPE_BOOLEAN)) return 0;
    if (!DUCKNNG_REGISTER_VOLATILE_SCALAR(con, "ducknng_register_sql_method", 4, ducknng_register_sql_method_scalar, ctx, register_sql_method_types, DUCKDB_TYPE_BOOLEAN)) return 0;
